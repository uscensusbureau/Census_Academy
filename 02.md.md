...
We'll just click that to select that search term, then click "GO." We should now see a table that looks something like this:
...
| B19083 | [GINI INDEX OF INCOME INEQUALITY](https://factfinder.census.gov/faces/tableservices/jsf/pages/productview.xhtml?pid=ACS_15_5YR_B19083&prodType=table) | 2016 ACS 5-year estimates | i |
| ... | ... | ... | ... |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMzI4Mzc1NzZdfQ==
-->