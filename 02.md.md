...
At this point, we could just download the data directly from AFF, which - if you're not a developer - might be the way to go. If this will suffice for you, click the **"Download"** button located above the table view pane. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNDQzOTczMTddfQ==
-->