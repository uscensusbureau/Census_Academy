...
To help us illustrate the following instructions, we are going to need an example topic. For this purpose, the author has chosen a topic of popular interest (determined by number of references in recent news media articles that credit US Census as their data source) **Income Inequality**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzkyOTI0NTkwXX0=
-->