...
At this point, we could just **"Download"** the data directly from AFF, which - if you're not a developer - might be the way to go
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgwNzk1MTcxN119
-->