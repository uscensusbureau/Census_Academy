...
This will bring up a dialog box from wherein you will select `State - 040` in this case. You'll then select `All States within the United States and Puerto Rico`, which will add this selection to "Your Selections" filters.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNTIwODE3NzJdfQ==
-->