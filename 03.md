...
Let's now find our specific variable in the [variables portion of the discovery tool](https://api.census.gov/data/2016/acs/acs1/variables.html) of interest by doing a ctrl+f for "B19083". 
> Warning: There are 10s of thousands of variables in here. Expect long load times.

We find a number of rows with this ID that might be of interest to us:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE5NzAyOCwtMTU4MTg1Mjc5MV19
-->