...
and click the [`examples`](https://api.census.gov/data/2016/acs/acs1/examples.html) link to see how calls are made at all the geographic levels available for that endpoint.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Mjg3NTI1NjUsLTE1ODE4NTI3OTFdfQ
==
-->