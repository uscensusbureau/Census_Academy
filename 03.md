...
https://api.census.gov/data/ **`year` or `timeseries`** / **`survey` or `producer`** / **`product`** / **`examples`, `geographies` or `variables`**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTExODQ3OTExNiwtMTU4MTg1Mjc5MV19
-->