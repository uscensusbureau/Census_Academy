...
This post will outline how the developer, data analyst/scientist or civic hacker can make sense of the DataWeb API and how to use it to get statistics. This is a longer tutorial, but r
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDM0NTc4NDMsLTE1ODE4NTI3OTFdfQ
==
-->