...
Now that we're armed with the variables we want, the endpoint we're accessing and the example call from the discovery tool
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNjMxNTkwMzgsLTE1ODE4NTI3OTFdfQ
==
-->