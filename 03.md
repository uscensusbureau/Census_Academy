...
We've used American Factfinder (AFF) to find a table `B19083` and variable name `GINI INDEX OF INCOME INEQUALITY` for our topic of interest (TOI). If we just needed to download this data, we have learned to do that and can call it a day. If 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMzMxNjI0NV19
-->