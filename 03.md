...
This looks relevant enough.  When we click this, we're directed to a new table view that should show the Gini Index for all the states in the US. We can also see on the left side of the results that these are available for every year back to 2006. So, it satisfies our need to 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTYyOTQ2MzgzXX0=
-->