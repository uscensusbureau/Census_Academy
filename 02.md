...
3. Comparing lower-level Census geographies (e.g., Tracts or Block-groups) can be challenging given that [such boundaries change over time](
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NTQwMzU3MTVdfQ==
-->